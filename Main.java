...
public class Main {
    ...
    public static void main(String args[]){
        ...
        String strthh[]= new String[n];
        String strtmm[]= new String[n];
        String endhh[]= new String[n];
        String endmm[]= new String[n];
        color=new int[n];
        vis=new boolean[n];
        ...
        for(int i=0;i<n;i++) {
            ...
            /*strthh[i] = String.valueOf((int)start_hh);
            strtmm[i] = String.valueOf((int)strt_mm);
            endhh[i] = String.valueOf((int)end_hh);
            endmm[i] = String.valueOf((int)end_mm);*/
            
            
        }/*
        for(int i=0;i<n;i++){
            System.out.println("Ride "+(i+1)+" "+(strthh[i])+":"+strtmm[i]+"-"+endhh[i]+":"+endmm[i]);
